...
interface ForgotPasswordHeaderBarProps {
  onBackPress?: () => void;
  onHelpPress?: () => void;
}

export const ForgotPasswordHeaderBar: React.FC<ForgotPasswordHeaderBarProps> = ({
  onBackPress,
  onHelpPress,
}) => {
  return (
...
const styles = StyleSheet.create({
  container: {
    ...
    borderBottomWidth: 1,
    borderBottomColor: `${ThemeTokens.colors.outlineVariant}30`,
  },
  actionButton: {
    width: 40,
    height: 40,
